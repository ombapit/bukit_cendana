const id = {
  ...
  landing: {
    ...
    mainFeaturesDesc: "Semua yang dibutuhkan untuk manajemen enterprise",
    ...
    features: {
      auth: { title: "Autentikasi Lengkap", desc: "Login, logout, refresh token, dan ganti password dengan JWT yang aman." },
      rbac: { title: "Dynamic RBAC", desc: "Role-Based Access Control dinamis dengan permission granular per modul." },
      menu: { title: "Menu Hierarki", desc: "Sistem menu dinamis yang terfilter otomatis sesuai permission user." },
      user: { title: "User Management", desc: "CRUD lengkap untuk pengelolaan user, role, dan permission." },
      dashboard: { title: "Dashboard Admin", desc: "Panel admin responsif dengan sidebar dinamis dan navigasi intuitif." },
      api: { title: "API Terintegrasi", desc: "REST API dengan Swagger UI, PostgreSQL, dan Redis untuk performa tinggi." },
    },
