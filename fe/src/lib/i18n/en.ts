const en = {
  ...
  landing: {
    ...
    features: {
      auth: { title: "Complete Authentication", desc: "Login, logout, refresh token, and change password with secure JWT." },
      rbac: { title: "Dynamic RBAC", desc: "Dynamic Role-Based Access Control with granular per-module permissions." },
      menu: { title: "Hierarchical Menu", desc: "Dynamic menu system auto-filtered based on user permissions." },
      user: { title: "User Management", desc: "Full CRUD for managing users, roles, and permissions." },
      dashboard: { title: "Admin Dashboard", desc: "Responsive admin panel with dynamic sidebar and intuitive navigation." },
      api: { title: "Integrated API", desc: "REST API with Swagger UI, PostgreSQL, and Redis for high performance." },
    },
